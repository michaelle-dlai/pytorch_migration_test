...
def show_ui_navigation_instructions(display_instructions: bool = False):
    """
    ...
    if display_instructions:
        instructions = """
* Once in the MLflow UI, you will find your experiment name (e.g., `CIFAR10_CNN_Lightning`) in the list on the left and click on it.

<p align="center">
  <img src="./nb_images/step_3.png" alt="Step 3 Image" style="width: 85%;"/>
</p>
...
<p align="center">
  <img src="./nb_images/step_4.png" alt="Step 4 Image" style="width: 75%;"/>
</p>

* You will be able to explore information about your selected run using the different tabs.

<p align="center">
  <img src="./nb_images/step_5.png" alt="Step 5 Image" style="width: 60%;"/>
</p>
...
<p align="center">
  <img src="./nb_images/step_6.png" alt="Step 6 Image" style="width: 60%;"/>
</p>

### Terminating the MLflow UI Server

* When you are done, return to your Jupyter Notebook and interrupt the kernel or press Enter in the input box to stop the server.
        """
...
def start_mlflow_ui(base_path='/mlflow', port=5000, jupyter_port=8888):
    ...
    nginx reverse proxy integration. It waits for user input to terminate the server.
    ...
    print("\nPress 'Interrupt Kernel' to stop the server.")
    print("="*60)
